    ...
    <div class="page-header">
        ...
        <div class="container-fluid">
            <div class="warning">
                ...
                <form method="post" action="../traitement/suppression_ingredient.php">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Ingrédients :</span>
                    <select name="ingredient" class="form-control">
                    <?php
                            $nom_complet = $_COOKIE['nom'];
                            $sql = $conn->query("SELECT DISTINCT ID , nom FROM ingrédient ");
