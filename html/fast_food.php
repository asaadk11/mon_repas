...
<html lang="fr">
    <head>
        <meta charset="utf-8" />
        <title>Mon repas-Fast Food</title>
...
?>
   ...
   <div class="page-header">
        ...
        <h2 style="font-size:7vw"><b>Fast Food</b></h2>

        <div class="row row-cols-1 row-cols-md-3 g-4">
         <?php
        $sql = $conn->query("SELECT lien_photo,nom,lien_page FROM recettes WHERE genre ='fast_food' ");
