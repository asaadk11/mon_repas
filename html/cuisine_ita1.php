...
?>
  ...
  <tbody>
    <?php
        $sql = $conn->query("SELECT nom_ingrédient,quantite FROM quantité WHERE nom_recette='Gratin de cannellonis ricotta, épinards, et sauce tomate' ");
  ...
  <?php
                        $sql2 = $conn->query("SELECT lien_video FROM recettes WHERE lien_page ='cuisine_ita1.php' ") ;
