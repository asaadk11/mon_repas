...
?>
  ...
  <tbody>
    <?php
        $sql = $conn->query("SELECT nom_ingrédient,quantite FROM quantité WHERE nom_recette='Hamburger forestier au boeuf, champignons et fromage fondu' ");
  ...
  <?php
                        $sql2 = $conn->query("SELECT lien_video FROM recettes WHERE lien_page ='fast_food1.php' ") ;
