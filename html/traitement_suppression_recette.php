    ...
    <div class="page-header">
        ...
        <div class="container-fluid">
            <div class="warning">
                ...
                <form method="post" action="../traitement/suppression_recette.php">
                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon1">Recettes :</span>
                    <select name="recette" class="form-control">
                    <?php
                            $sql = $conn->query("SELECT DISTINCT ID , nom FROM recettes ");
