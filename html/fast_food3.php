...
?>
  ...
  <tbody>
    <?php
        $sql = $conn->query("SELECT nom_ingrédient,quantite FROM quantité WHERE nom_recette='Sandwich végétarien au cheddar fondu et légumes grillés' ");
  ...
  <?php
                        $sql2 = $conn->query("SELECT lien_video FROM recettes WHERE lien_page ='fast_food3.php' ") ;
