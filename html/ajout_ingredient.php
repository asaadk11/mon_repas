...
<html lang="fr">
    ...
    <div class="page-header">
        ...
        <div class="container-fluid">
            <div class="warning">
                <form action="../traitement/ajout_ingredient.php" method="post">
                    <h4>Ajouter un ingrédient : </h4><br>
                    <div class="input-group mb-3">
    <span class="input-group-text" id="basic-addon1">Nom  </span>
    <input type="text" placeholder="Nom ingrédient" name="nom_ingredient" class="form-control" required><br>
    </div>
