...
?>
  ...
  <tbody>
    <?php
        $sql = $conn->query("SELECT nom_ingrédient,quantite FROM quantité WHERE nom_recette='salade compose' ");
  ...
  <?php
                        $sql2 = $conn->query("SELECT lien_video FROM recettes WHERE lien_page ='salade2.php' ") ;
